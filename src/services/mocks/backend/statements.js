...
const statements = [
    ...
    http.get(`${statementsUrl}object/:id`, ({ params }) => {
        const { id } = params;
        const MAPPING = {
    ...
    http.get(`${statementsUrl}subject/:id/`, ({ params }) => {
        const { id } = params;
        const MAPPING = {
    ...
    http.get(`${statementsUrl}object/:id/predicate/sh:targetClass/`, ({ params }) => {
        const { id } = params;
        const MAPPING = {
    ...
    http.post(statementsUrl, async ({ request }) => {
        const { subject_id, predicate_id, object_id } = await request.json();
        return HttpResponse.json({

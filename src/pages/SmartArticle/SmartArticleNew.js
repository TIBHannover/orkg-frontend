        ...
        <>
            <Container>
                <div className="d-flex align-items-center">
                    <h1 className="h4 mt-4 mb-4 flex-grow-1">Create smart review</h1>
                </div>
            </Container>
            <Container className="box rounded pt-4 pb-4 pl-5 pr-5">
                <p>
                    Smart reviews are dynamic, community maintained scholarly articles and are especially suitable for survey papers. Before creating
                    an article, make sure you understand the following points:
                </p>
                <ul className="mt-4">
                    <li>
                        A smart review can be <strong>changed by anyone</strong> (indeed, just like Wikipedia)
                    </li>
                    <li>

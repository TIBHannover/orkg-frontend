const routes = {
    ...
    PAPERS: '/papers',
    CREATE_PAPER: '/content-type/create?type=Paper',
    ...
    CREATE_COMPARISON: '/content-type/create?type=Comparison',
    ...
    REVIEW_NEW: '/content-type/create?type=SmartReview',
    TOOLS: '/tools',
    ...
    LIST_NEW: '/content-type/create?type=LiteratureList',

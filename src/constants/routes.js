const routes = {
    ...
    VIEW_PAPER_NO_CONTRIBUTION: '/paper/:resourceId',
    ...
    VISUALIZATION_NO_ID: '/visualization/',
...
const legacyRoutes = {
    ...
    LITERATURE_LIST_NO_EMBED: '/literature-list/:id/',

...
const CreateForm: FC<CreateFormProps> = ({ classId }) => {
    ...
    return (
        <Form onSubmit={(e) => handleCreate(e, title)}>
            <FormGroup>
                <Tooltip content="Choose the title of your dataset. You can always update the title later.">
                    <span>
                        <Label for="datasetTitle">Title</Label> <FontAwesomeIcon icon={faQuestionCircle} className="text-secondary" />
                    </span>
                </Tooltip>
                <InputGroup>
                    <Input

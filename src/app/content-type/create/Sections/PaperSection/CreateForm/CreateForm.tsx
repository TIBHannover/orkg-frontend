...
const CreateForm = () => {
    ...
    const onCreate = ({ paperId }: { paperId: string }) => {
    ...
    return (
        <div>
            ...
            <div className="flex flex-col items-end gap-3 md:flex-row md:items-center md:justify-end md:gap-6">
                <span className="text-sm italic text-muted">After adding the paper, you will be able to add structured data</span>

...
export const literatureListSlice = createSlice({
    name: 'literatureList',
    initialState,
    reducers: {
        ...
        titleUpdated: (state, { payload }) => {
            state.literatureList.title = payload;
        },
        ...
        listEntryAdded: (state, { payload }) => {
            const { entry, sectionId, statementId, paperData } = payload;
            ...
            state.papers[paperData.paper.id] = paperData;
        },
...
export const {
    ...
    listEntriesSorted
} = literatureListSlice.actions;

export default literatureListSlice.reducer;

...
class CustomizationPieChart extends Component {
    constructor(props) {
        ...
        this.errorCodeMessages = {
            COL_CHART_NO_STRING_TYPES_FOR_LABEL: 'PieChart error: It appears there is no column mapped as string for labels',
            COL_CHART_NO_NUMBER_TYPES_FOR_VALUE: 'PieChart error: It appears there is no column mapped as number for values',
        };

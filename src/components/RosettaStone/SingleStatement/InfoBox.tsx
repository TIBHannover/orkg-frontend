...
type InfoBoxProps = {
    ...
    /** Opens the versions modal, which is owned by the parent statement */
    openVersionsModal: () => void;
};

const InfoBox: FC<InfoBoxProps> = ({ statement, template, certainty, setCertainty, isEditing, openVersionsModal }) => {

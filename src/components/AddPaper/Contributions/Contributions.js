                ...
                createContribution({
                    ...
                    statements: {
                        properties: (() => {
                            ...
                            if (method) {
                                property.push({ existingPredicateId: PREDICATES.HAS_METHODS, propertyId: PREDICATES.HAS_METHODS, label: 'Method' });
                            }
                            if (conclusion) {
                        ...
                        values: (() => {
                            ...
                            if (method) {
                                valuesArray.push({
                                    _class: 'literal',
                                    label: method,
                                    propertyId: PREDICATES.HAS_METHODS,
                                    existingPredicateId: PREDICATES.HAS_METHODS,
                                });
                            }
                            if (conclusion) {
                                valuesArray.push({

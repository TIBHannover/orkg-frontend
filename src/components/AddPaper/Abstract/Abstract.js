        ...
        return (
            <div>
                ...
                {this.props.abstract && !this.state.changeAbstract ?
                    ...
                    : 
                    <Alert color="info">
                        <strong>Info:</strong> please enter the abstract of your paper
                    </Alert> 
                }
                ...
                <Card>
                    <CardBody>
                        ...
                        {!this.state.changeAbstract ?
                            ...
                            :
                            <Textarea className="form-control pl-2 pr-2" minRows="5" value={this.props.abstract} onChange={this.handleChange} />
                        }
                    </CardBody>
                </Card>

                <Button color="light" className="mb-2 mt-1" onClick={this.handleChangeAbstract}>{this.state.changeAbstract ? 'Annotate abstact' : 'Change abstact'}</Button>

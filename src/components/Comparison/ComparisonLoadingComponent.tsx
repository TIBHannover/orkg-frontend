        ...
        <table className="mb-0 table" style={{ maxWidth: 1044 }}>
            <tbody className="table-borderless">
                <tr className="table-borderless" style={{ borderStyle: 'hidden' }}>
                    <td className="p-0">
                        <ContentLoader height={50} width={250} viewBox="0 0 250 50" speed={2} backgroundColor="#80869B">
                    ...
                    {times(COLUMN_AMOUNT, (i) => (
                        <td className="p-0" key={i}>
                            <BorderTopRadius>
                                <ContentLoader height={50} width={250} viewBox="0 0 250 50" speed={2} backgroundColor="#E86161">
                                    <rect x="0" y="0" rx="0" ry="0" width="250" height="50" />
                                </ContentLoader>
                            </BorderTopRadius>
                        </td>
                ...
                <tr className="table-borderless" style={{ borderStyle: 'hidden' }}>
                    <td className="p-0">
                        <ContentLoader height={250} width={250} viewBox="0 0 250 250" speed={2} backgroundColor="#80869B">
                    ...
                    {times(COLUMN_AMOUNT, (i) => (
                        <td className="p-0" key={i}>
                            <BorderBottomRadius>
                                <ContentLoader height={250} width={250} viewBox="0 0 250 250" speed={2}>
                                    <rect x="0" y="0" rx="0" ry="0" width="250" height="250" />
                                </ContentLoader>
                            </BorderBottomRadius>
                        </td>

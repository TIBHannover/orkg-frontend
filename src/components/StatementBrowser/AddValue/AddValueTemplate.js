...
export default function AddValueTemplate(props) {
    ...
    const [entityType, setEntityType] = useState(getConfigByType(props.isLiteral ? MISC.DEFAULT_LITERAL_DATATYPE : ENTITIES.RESOURCE)._class);
    const [inputValue, setInputValue] = useState('');
    const [inputDataType, setInputDataType] = useState(getConfigByType(props.isLiteral ? MISC.DEFAULT_LITERAL_DATATYPE : ENTITIES.RESOURCE).type);
    ...
    useEffect(() => {
        ...
        } else if (resourceInputRef.current && (entityType === ENTITIES.RESOURCE || entityType === 'property')) {
    ...
    useEffect(() => {
        setInputDataType(getConfigByType(props.isLiteral ? MISC.DEFAULT_LITERAL_DATATYPE : ENTITIES.RESOURCE).type);

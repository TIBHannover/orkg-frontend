...
import ValueItem from './ValueItem/ValueItemContainer';
import AddValue from './AddValue/AddValueContainer';
                    ...
                    <Collapse isOpen={isCollapsed}>
                        <StyledListGroupOpen className={openBoxClass}>
                            <ListGroup flush>
                                ...
                                {this.props.enableEdit ? <AddValue propertyId={this.props.id} syncBackend={this.props.syncBackend} /> : ''}
                            </ListGroup>
                        </StyledListGroupOpen>
                    </Collapse>
                </>

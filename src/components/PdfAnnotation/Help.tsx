...
const Help: FC<HelpProps> = ({ setIsOpen, isOpen }) => {
    ...
    const tourSteps = [
        {
            intro: (
                <div style={{ width: '400px' }}>
                    ...
                    <p>
                        The tool also offers the capability to <strong>extract survey tables</strong>, whose information is used to add papers to the
                        ORKG.
                    </p>
        ...
        {
            element: '#annotation-tables',
            intro: (
                <>
                    <p>
                        Here, you can extract the survey tables or general tables from the document. These tables contain structured information that
    ...
    return <Steps onExit={handleCloseTour} enabled={isOpen} initialStep={0} steps={tourSteps} options={{ tooltipClass: 'introjs-ORKG-tooltip' }} />;
};

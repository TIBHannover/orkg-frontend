                ...
                <Row>
                    ...
                    <FooterCol md={3}>
                        ...
                        <ul className={'p-0'} style={{ listStyle: 'none' }}>
                            <li><a href="https://projects.tib.eu/orkg/" target="_blank" rel="noopener noreferrer">About us</a></li>
                            <li><a href="https://projects.tib.eu/orkg/get-involved/" target="_blank" rel="noopener noreferrer">Get involved</a></li>
                            <li><a href="https://twitter.com/orkg_org" target="_blank" rel="noopener noreferrer">Follow us</a></li>
                        </ul>
                    </FooterCol>
                    <FooterCol md={3}>
                        <h5>Technical</h5>
